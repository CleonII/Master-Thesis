function evalYmod(u, t, dynPar, obsPar, paramData, obsData, observableId, simulationId) 
	...
	if observableId == "pRII_Microscopy" 
		observableParameter1_pRII_Microscopy = getObsOrSdParam(obsPar, paramData, obsData, observableId, simulationId, t)
	...
	if observableId == "Calpha_Microscopy" 
		observableParameter1_Calpha_Microscopy = getObsOrSdParam(obsPar, paramData, obsData, observableId, simulationId, t)
...
function evalU0!(u0Vec, paramVec) 
	...
	Fsk_time, kp_AC, kdp_AC, KD_Fsk, kf_Fsk, Fsk_level, Rp8_Br_cAMPS_pAB_level, Rp8_Br_cAMPS_pAB_incubation_time, xi_i_Rp8_Br_cAMPS_pAB, ki_Rp8_Br_cAMPS_pAB, ki_Rp8_pCPT_cAMPS_pAB, xi_i_Rp8_pCPT_cAMPS_pAB, Rp8_pCPT_cAMPS_pAB_level, Rp8_pCPT_cAMPS_pAB_incubation_time, KD_PDE_Csub, kf_PDE_Csub, xi_i_Rp_cAMPS_pAB, Rp_cAMPS_pAB_level, Rp_cAMPS_pAB_incubation_time, ki_Rp_cAMPS_pAB, kf_RIIp_2__RII_2, kf_RII_2__RII_C_2, kf_RII_C_2__RII_2, kf_cAMP, xi_b_Rp8_Br_cAMPS, KD_cAMP, xi_KD_Rp8_Br_cAMPS, xi_AC_cAMP_Fsk, kdeg_cAMP_free, KD_IBMX, xi_pAC, xi_pPDE, ks_AC_cAMP, xi_b_Sp8_Br_cAMPS, kf_RIIp_cAMP_C_2__RIIp_2, xi_KD_Sp8_Br_cAMPS, ki_IBMX, IBMX_time, IBMX_level, kf_RII_C_2__RIIp_C_2, xi_b_Rp8_pCPT_cAMPS, xi_KD_Rp8_pCPT_cAMPS, kf_RIIp_C_2__RII_C_2, xi_kf_RII_C_2__RII_2, xi_b_Rp_cAMPS, kdeg_cAMP, xi_kf_RII_2__RII_C_2, xi_KD_Rp_cAMPS, ki_Sp8_Br_cAMPS_AM, xi_i_Sp8_Br_cAMPS_AM, Sp8_Br_cAMPS_AM_time, Sp8_Br_cAMPS_AM_level, KD_H89, H89_time, kf_H89, H89_level, nuc, RII2_total, PDE_total, fourABnOH_level, default, fourABnOH_incubation_time, AC_total = paramVec 
...
function evalSd!(u, t, sdPar, dynPar, paramData, obsData, observableId, simulationId) 
	...
	if observableId == "pRII_Microscopy" 
		noiseParameter1_pRII_Microscopy = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
