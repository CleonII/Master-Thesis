function getCallbacks_model_Isensee_JCB2018()
	...
	return CallbackSet(cb_H89_bool1, cb_Sp8_Br_cAMPS_AM_bool1, cb_Rp_cAMPS_pAB_bool1, cb_Fsk_bool1, cb_IBMXex_bool1, cb_fourABnOH_bool1, cb_Rp8_Br_cAMPS_pAB_bool1, cb_Rp8_pCPT_cAMPS_pAB_bool1), [activeAtTime0_H89_bool1!, activeAtTime0_Sp8_Br_cAMPS_AM_bool1!, activeAtTime0_Rp_cAMPS_pAB_bool1!, activeAtTime0_Fsk_bool1!, activeAtTime0_IBMXex_bool1!, activeAtTime0_fourABnOH_bool1!, activeAtTime0_Rp8_Br_cAMPS_pAB_bool1!, activeAtTime0_Rp8_pCPT_cAMPS_pAB_bool1!]
end
...
function activeAtTime0_H89_bool1!(u, p)
...
function activeAtTime0_Sp8_Br_cAMPS_AM_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function activeAtTime0_Rp_cAMPS_pAB_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function activeAtTime0_Fsk_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function activeAtTime0_IBMXex_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function activeAtTime0_fourABnOH_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function activeAtTime0_Rp8_Br_cAMPS_pAB_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function activeAtTime0_Rp8_pCPT_cAMPS_pAB_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function getTstops(u, p)
	 return [dualToFloat(p[28]), dualToFloat(p[46]), dualToFloat(p[17]), dualToFloat(p[38]), dualToFloat(p[15]), dualToFloat(p[5]), dualToFloat(p[51]), dualToFloat(p[39])]
end