...
function compute_∂h∂u!(u, t::Real, pODEProblem::AbstractVector, θ_observable::AbstractVector,                    
	...
	if observableId == :pRII_Microscopy 
		...
		out[9] = observableParameter1_pRII_Microscopy*θ_nonDynamic[6]*(2θ_nonDynamic[3] - 2θ_nonDynamic[10]*(θ_nonDynamic[3] - 1))
		...
		out[25] = observableParameter1_pRII_Microscopy*θ_nonDynamic[6]*(2θ_nonDynamic[3] - 2θ_nonDynamic[10]*(θ_nonDynamic[3] - 1))
		return nothing
	end
	...
	if observableId == :Calpha_Microscopy 
		...
		out[9] = observableParameter1_Calpha_Microscopy*θ_nonDynamic[4]*(2θ_nonDynamic[3] - 2θ_nonDynamic[10]*(θ_nonDynamic[3] - 1))
		...
		out[25] = observableParameter1_Calpha_Microscopy*θ_nonDynamic[4]*(2θ_nonDynamic[3] - 2θ_nonDynamic[10]*(θ_nonDynamic[3] - 1))
		return nothing
	end
