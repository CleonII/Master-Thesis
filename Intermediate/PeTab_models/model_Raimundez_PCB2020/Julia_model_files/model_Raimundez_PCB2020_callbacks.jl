function getCallbacks_model_Raimundez_PCB2020()
	...
	return CallbackSet(cb_CET_bool1, cb_EGF_bool1, cb_METinh_bool1), [isActiveAtTime0_CET_bool1!, isActiveAtTime0_EGF_bool1!, isActiveAtTime0_METinh_bool1!]
end
...
function isActiveAtTime0_CET_bool1!(u, p)
...
function isActiveAtTime0_METinh_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function computeTstops(u::AbstractVector, p::AbstractVector)
	 return Float64[dualToFloat(-0.0), dualToFloat(-0.0), dualToFloat(-0.0)]
end