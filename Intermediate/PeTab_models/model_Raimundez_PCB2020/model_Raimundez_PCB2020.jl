...
function getODEModel_model_Raimundez_PCB2020()
    ...
    ### Derivatives ###
    eqs = [
    D(EGFR) ~ +1.0 * ( 1 /cyt ) * (cyt * (ksyn_EGFR__MKN1_fm * relative_ksyn_EGFR * exp(HS746T * d_ksyn_EGFR__MKN1_2_HS746T + d_ksyn_EGFR__fm_2_hm * hunger_medium)))-1.0 * ( 1 /cyt ) * (cyt * EGFR * (kdeg_membran__MKN1 * exp(HS746T * d_kdeg_membran__MKN1_2_HS746T)))-1.0 * ( 1 /cyt ) * (cyt * (6.86 * CET_level * (1 + (t < 0) * ((0) - (1)))) * EGFR * kbin_EGFR_CET)+1.0 * ( 1 /cyt ) * (cyt * EGFR_CET * KD_EGFR_CET * kbin_EGFR_CET)-1.0 * ( 1 /cyt ) * (cyt * (0.161 * EGF_level * (1 + (t < 0) * ((0) - (1)))) * EGFR * kbin_EGFR_EGF)+1.0 * ( 1 /cyt ) * (cyt * EGFR_EGF * KD_EGFR_EGF * kbin_EGFR_EGF)+2.0 * ( 1 /cyt ) * (cyt * (kexp_pEGFR_EGF_2_i__MKN1 * exp(HS746T * d_kexp_pEGFR_EGF_2_i__MKN1_2_HS746T)) * pEGFR_EGF_2_i)-1.0 * ( 1 /cyt ) * (cyt * EGFR * MMET * kdim_MMET_EGFR * xi_kdim_MMET_EGFR)+1.0 * ( 1 /cyt ) * (cyt * (kexp_pEGFR_EGF_2_i__MKN1 * exp(HS746T * d_kexp_pEGFR_EGF_2_i__MKN1_2_HS746T)) * pMMET_pEGFR_i * xi_kexp_pMMET_pEGFR_i)-1.0 * ( 1 /cyt ) * (cyt * EGFR * MMET_METinh * kdim_MMET_EGFR * xi_kdim_MMET_EGFR),
    ...
    D(MMET_METinh_2) ~ +1.0 * ( 1 /cyt ) * (cyt * (MMET_METinh)^(2) * kdim_MMET * xi_kdim_MMET)+1.0 * ( 1 /cyt ) * (cyt * (METinh_level * (1 + (t < 0) * ((0) - (1)))) * MMET_MMET_METinh * kdim_MMETinh)-1.0 * ( 1 /cyt ) * (cyt * MMET_METinh_2 * (kdeg_membran__MKN1 * exp(HS746T * d_kdeg_membran__MKN1_2_HS746T))),
    ...
    D(MMET_2) ~ +1.0 * ( 1 /cyt ) * (cyt * (MMET)^(2) * kdim_MMET * xi_kdim_MMET)-1.0 * ( 1 /cyt ) * (cyt * MMET_2 * kpho_MMET * xi_kpho_MMET)-1.0 * ( 1 /cyt ) * (cyt * MMET_2 * (kdeg_membran__MKN1 * exp(HS746T * d_kdeg_membran__MKN1_2_HS746T)))-1.0 * ( 1 /cyt ) * (cyt * (METinh_level * (1 + (t < 0) * ((0) - (1)))) * MMET_2 * kdim_MMETinh),
    ...
    D(MMET_MMET_METinh) ~ +1.0 * ( 1 /cyt ) * (cyt * MMET * MMET_METinh * kdim_MMET * xi_kdim_MMET)+1.0 * ( 1 /cyt ) * (cyt * (METinh_level * (1 + (t < 0) * ((0) - (1)))) * MMET_2 * kdim_MMETinh)-1.0 * ( 1 /cyt ) * (cyt * (METinh_level * (1 + (t < 0) * ((0) - (1)))) * MMET_MMET_METinh * kdim_MMETinh)-1.0 * ( 1 /cyt ) * (cyt * MMET_MMET_METinh * (kdeg_membran__MKN1 * exp(HS746T * d_kdeg_membran__MKN1_2_HS746T))),
    ...
    D(EGFR_EGF) ~ +1.0 * ( 1 /cyt ) * (cyt * (0.161 * EGF_level * (1 + (t < 0) * ((0) - (1)))) * EGFR * kbin_EGFR_EGF)-1.0 * ( 1 /cyt ) * (cyt * EGFR_EGF * KD_EGFR_EGF * kbin_EGFR_EGF)-2.0 * ( 1 /cyt ) * (cyt * (EGFR_EGF)^(2) * kdim_EGFR_EGF)-1.0 * ( 1 /cyt ) * (cyt * EGFR_EGF * (kdeg_membran__MKN1 * exp(HS746T * d_kdeg_membran__MKN1_2_HS746T))),
    D(MMET_METinh) ~ +1.0 * ( 1 /cyt ) * (cyt * (METinh_level * (1 + (t < 0) * ((0) - (1)))) * MMET * kdim_MMETinh)-1.0 * ( 1 /cyt ) * (cyt * KD_METinh * MMET_METinh * kdim_MMETinh)-1.0 * ( 1 /cyt ) * (cyt * MMET_METinh * (kdeg_membran__MKN1 * exp(HS746T * d_kdeg_membran__MKN1_2_HS746T)))-1.0 * ( 1 /cyt ) * (cyt * MMET * MMET_METinh * kdim_MMET * xi_kdim_MMET)-2.0 * ( 1 /cyt ) * (cyt * (MMET_METinh)^(2) * kdim_MMET * xi_kdim_MMET)-1.0 * ( 1 /cyt ) * (cyt * EGFR * MMET_METinh * kdim_MMET_EGFR * xi_kdim_MMET_EGFR),
