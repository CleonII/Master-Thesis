function evalYmod(u, t, dynPar, obsPar, paramData, obsData, observableId, simulationId) 
	...
	Glu, cGlu, Ind, Bac, lag, dummyVariable= u 
...
function evalU0!(u0Vec, paramVec) 
	...
	u0Vec .= Glu, cGlu, Ind, Bac, lag, dummyVariable
end
...
function evalSd!(u, t, sdPar, dynPar, paramData, obsData, observableId, simulationId) 
	...
	if observableId == "Bacnorm" 
		noiseParameter1_Bacnorm = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_Bacnorm 
	end

	if observableId == "IndconcNormRange" 
		noiseParameter1_IndconcNormRange = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
