function getCallbacks_model_Brannmark_JBC2010()
	...
	return CallbackSet(cb_insulin_bool1, cb_insulin_bool2), [activeAtTime0_insulin_bool1!, activeAtTime0_insulin_bool2!]
end
...
function activeAtTime0_insulin_bool1!(u, p)
...
function activeAtTime0_insulin_bool2!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function getTstops(u, p)
	 return [dualToFloat(p[10]), dualToFloat(p[11])]
end