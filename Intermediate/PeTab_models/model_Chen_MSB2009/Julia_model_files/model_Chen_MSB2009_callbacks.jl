function getCallbacks_model_Chen_MSB2009()
	...
	return CallbackSet(cb_Step1_bool3, cb_StepMini_bool2, cb_Step33_bool1, cb_Step1_bool2, cb_Step33_bool3, cb_StepLate_bool1, cb_Step1_bool1, cb_Step10Mio_bool2, cb_Step10Mio_bool1, cb_Step33_bool2, cb_StepLate_bool3, cb_Step10Mio_bool3, cb_Step5_bool1, cb_Step5_bool3, cb_StepMini_bool1, cb_Step5_bool2, cb_StepMini_bool3, cb_StepLate_bool2), [isActiveAtTime0_Step1_bool3!, isActiveAtTime0_StepMini_bool2!, isActiveAtTime0_Step33_bool1!, isActiveAtTime0_Step1_bool2!, isActiveAtTime0_Step33_bool3!, isActiveAtTime0_StepLate_bool1!, isActiveAtTime0_Step1_bool1!, isActiveAtTime0_Step10Mio_bool2!, isActiveAtTime0_Step10Mio_bool1!, isActiveAtTime0_Step33_bool2!, isActiveAtTime0_StepLate_bool3!, isActiveAtTime0_Step10Mio_bool3!, isActiveAtTime0_Step5_bool1!, isActiveAtTime0_Step5_bool3!, isActiveAtTime0_StepMini_bool1!, isActiveAtTime0_Step5_bool2!, isActiveAtTime0_StepMini_bool3!, isActiveAtTime0_StepLate_bool2!]
end
...
function isActiveAtTime0_Step1_bool3!(u, p)
...
function isActiveAtTime0_StepMini_bool2!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step33_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step1_bool2!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step33_bool3!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_StepLate_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step1_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step10Mio_bool2!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step10Mio_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step33_bool2!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_StepLate_bool3!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step10Mio_bool3!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step5_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step5_bool3!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_StepMini_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_Step5_bool2!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_StepMini_bool3!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function isActiveAtTime0_StepLate_bool2!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
