...
function evalSd!(u, t, sdPar, dynPar, paramData, obsData, observableId, simulationId) 
	...
	if observableId == "observable_K27me0K36me0" 
		noiseParameter1_observable_K27me0K36me0 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me0K36me0 
	end

	if observableId == "observable_K27me0K36me1" 
		noiseParameter1_observable_K27me0K36me1 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me0K36me1 
	end

	if observableId == "observable_K27me0K36me2" 
		noiseParameter1_observable_K27me0K36me2 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me0K36me2 
	end

	if observableId == "observable_K27me0K36me3" 
		noiseParameter1_observable_K27me0K36me3 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me0K36me3 
	end

	if observableId == "observable_K27me1K36me0" 
		noiseParameter1_observable_K27me1K36me0 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me1K36me0 
	end

	if observableId == "observable_K27me1K36me1" 
		noiseParameter1_observable_K27me1K36me1 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me1K36me1 
	end

	if observableId == "observable_K27me1K36me2" 
		noiseParameter1_observable_K27me1K36me2 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me1K36me2 
	end

	if observableId == "observable_K27me1K36me3" 
		noiseParameter1_observable_K27me1K36me3 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me1K36me3 
	end

	if observableId == "observable_K27me2K36me0" 
		noiseParameter1_observable_K27me2K36me0 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me2K36me0 
	end

	if observableId == "observable_K27me2K36me1" 
		noiseParameter1_observable_K27me2K36me1 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me2K36me1 
	end

	if observableId == "observable_K27me2K36me2" 
		noiseParameter1_observable_K27me2K36me2 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me2K36me2 
	end

	if observableId == "observable_K27me2K36me3" 
		noiseParameter1_observable_K27me2K36me3 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me2K36me3 
	end

	if observableId == "observable_K27me3K36me0" 
		noiseParameter1_observable_K27me3K36me0 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me3K36me0 
	end

	if observableId == "observable_K27me3K36me1" 
		noiseParameter1_observable_K27me3K36me1 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_K27me3K36me1 
	end

	if observableId == "observable_K27me3K36me2" 
		noiseParameter1_observable_K27me3K36me2 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
