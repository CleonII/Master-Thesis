function evalYmod(u, t, dynPar, obsPar, paramData, obsData, observableId, simulationId) 
	...
	if observableId == "observable_IR1" 
		observableParameter2_observable_IR1, observableParameter1_observable_IR1 = getObsOrSdParam(obsPar, paramData, obsData, observableId, simulationId, t)
		return observableParameter2_observable_IR1 * ( IR1 + IR1in + observableParameter1_observable_IR1 ) 
	end

	if observableId == "observable_IR2" 
		observableParameter2_observable_IR2, observableParameter1_observable_IR2 = getObsOrSdParam(obsPar, paramData, obsData, observableId, simulationId, t)
		return observableParameter2_observable_IR2 * ( IR2 + IR2in + observableParameter1_observable_IR2 ) 
	end

	if observableId == "observable_IRsum" 
		observableParameter2_observable_IRsum, observableParameter1_observable_IRsum = getObsOrSdParam(obsPar, paramData, obsData, observableId, simulationId, t)
	...
	if observableId == "observable_Insulin" 
		observableParameter1_observable_Insulin, observableParameter2_observable_Insulin, observableParameter3_observable_Insulin, observableParameter3_observable_Insulin, observableParameter4_observable_Insulin = getObsOrSdParam(obsPar, paramData, obsData, observableId, simulationId, t)
...
function evalSd!(u, t, sdPar, dynPar, paramData, obsData, observableId, simulationId) 
	...
	if observableId == "observable_IR1" 
		noiseParameter1_observable_IR1 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_IR1 
	end

	if observableId == "observable_IR2" 
		noiseParameter1_observable_IR2 = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_IR2 
	end

	if observableId == "observable_IRsum" 
		noiseParameter1_observable_IRsum = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
		return noiseParameter1_observable_IRsum 
	end

	if observableId == "observable_Insulin" 
		noiseParameter1_observable_Insulin = getObsOrSdParam(sdPar, paramData, obsData, observableId, simulationId, t, getObsPar=false)
