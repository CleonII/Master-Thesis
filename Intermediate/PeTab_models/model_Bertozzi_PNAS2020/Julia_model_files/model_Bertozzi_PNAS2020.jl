...
function getODEModel_model_Bertozzi_PNAS2020()
    ...
    ### Define parameters
    ModelingToolkit.@parameters Lockdown_NY_end Pop_CA Ro_bool1 Ro_bool2 Io_CA Ro_bool3 Ro_bool4 Pop_NY Io_NY Trigger_NY USA___CA__NY Lockdown_CA_start gamma_NY Trigger_Lockdown Ro_NY Lockdown_CA_end gamma_CA Ro_CA Lockdown_NY_start

    ### Store parameters in array for ODESystem command
    parameterArray = [Lockdown_NY_end, Pop_CA, Ro_bool1, Ro_bool2, Io_CA, Ro_bool3, Ro_bool4, Pop_NY, Io_NY, Trigger_NY, USA___CA__NY, Lockdown_CA_start, gamma_NY, Trigger_Lockdown, Ro_NY, Lockdown_CA_end, gamma_CA, Ro_CA, Lockdown_NY_start]
