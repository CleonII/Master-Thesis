function evalYmod(u, t, dynPar, obsPar, nonDynParam, paramData, observableId, mapObsParam) 
	...
	CISEqc, CISRNATurn, SHP1ActEpoR, SHP1ProOE, SOCS3Inh, SOCS3RNATurn, STAT5ActEpoR, STAT5ActJAK2, init_EpoRJAK2, init_SHP1 = dynPar 
	CISEqcOE_C = paramData.paramVal[2] 
	CISInh_C = paramData.paramVal[3] 
	CISRNADelay_C = paramData.paramVal[4] 
	CISRNAEqc_C = paramData.paramVal[5] 
	CISTurn_C = paramData.paramVal[7] 
	EpoRActJAK2_C = paramData.paramVal[8] 
	EpoRCISInh_C = paramData.paramVal[9] 
	EpoRCISRemove_C = paramData.paramVal[10] 
	JAK2ActEpo_C = paramData.paramVal[11] 
	JAK2EpoRDeaSHP1_C = paramData.paramVal[12] 
	SHP1Dea_C = paramData.paramVal[14] 
	SOCS3Eqc_C = paramData.paramVal[16] 
	SOCS3EqcOE_C = paramData.paramVal[17] 
	SOCS3RNADelay_C = paramData.paramVal[19] 
	SOCS3RNAEqc_C = paramData.paramVal[20] 
	SOCS3Turn_C = paramData.paramVal[22] 
	STAT5Exp_C = paramData.paramVal[25] 
	STAT5Imp_C = paramData.paramVal[26] 
	init_STAT5_C = paramData.paramVal[29] 
	...
	if observableId == "observable_SOCS3_au" 
		...
		return observableParameter1_observable_SOCS3_au + SOCS3 * observableParameter2_observable_SOCS3_au / SOCS3Eqc_C 
	end
	...
	if observableId == "observable_pSTAT5_au" 
		...
		return observableParameter1_observable_pSTAT5_au + pSTAT5 * observableParameter2_observable_pSTAT5_au / init_STAT5_C 
	end
	...
	if observableId == "observable_tSTAT5_au" 
		...
		return observableParameter1_observable_tSTAT5_au * ( STAT5 + pSTAT5 ) / init_STAT5_C 
	end
