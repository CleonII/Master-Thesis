function getCallbacks_model_Weber_BMC2015()
	...
	return CallbackSet(cb_u4_bool1, cb_u6_bool1, cb_u5_bool1, cb_u3_bool1), [activeAtTime0_u4_bool1!, activeAtTime0_u6_bool1!, activeAtTime0_u5_bool1!, activeAtTime0_u3_bool1!]
end
...
function activeAtTime0_u4_bool1!(u, p)
...
function activeAtTime0_u6_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function activeAtTime0_u5_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function activeAtTime0_u3_bool1!(u, p)
	t = 0.0 # Used to check conditions activated at t0=0
...
function getTstops(u, p)
	 return [dualToFloat(-0.0), dualToFloat(p[7]), dualToFloat(p[22]), dualToFloat(-0.0)]
end