function evalYmod(u, t, dynPar, obsPar, nonDynParam, paramData, observableId, mapObsParam) 
	...
	pAkt_S6, pAkt, pS6, EGFR, pEGFR_Akt, pEGFR, Akt, S6, EGF_EGFR, dummyVariable= u 
...
function evalU0!(u0Vec, paramVec) 
	...
	reaction_5_k2, reaction_5_k1, reaction_6_k1, reaction_3_k1, reaction_7_k1, reaction_8_k1, EGFR_turnover, reaction_1_k2, reaction_1_k1, reaction_2_k2, reaction_2_k1, reaction_4_k1, reaction_9_k1, EGF_end, EGF_rate, EGF_0, init_AKT, init_S6, init_EGFR = paramVec 
	...
	u0Vec .= pAkt_S6, pAkt, pS6, EGFR, pEGFR_Akt, pEGFR, Akt, S6, EGF_EGFR, dummyVariable
end
