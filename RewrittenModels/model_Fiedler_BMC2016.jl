...
@variables t RAF(t) MEK(t) pMEK(t) pERK(t) pRAF(t) ERK(t)
...
### Define parameters
@parameters ERK_total UO126 k10 RAF_total K_3 k4 Sorafenib K_2 k6 k11 tau1 MEK_total K_1 k3 tau2 k5 k2
