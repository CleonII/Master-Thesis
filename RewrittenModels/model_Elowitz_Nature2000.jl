...
@variables t X_protein(t) GFP_mRNA(t) Y_mRNA(t) X_mRNA(t) Z_mRNA(t) Z_protein(t) Y_protein(t) GFP(t)
...
### Define parameters
@parameters tau_mRNA tps_repr init_GFP n_Hill init_Y_mRNA init_Z_mRNA init_X_protein init_Y_protein tau_mRNA_GFP eff init_Z_protein tau_prot_GFP eff_GFP tps_active init_GFP_mRNA KM init_X_mRNA tau_prot
